# Implementation Plan & Report Writing Guidelines

This document defines **how to write Implementation Plans and Reports** using the adopted templates.

The primary goal is:

> **A future reader (AI or human) must be able to quickly understand:**
...
You can add any other files in devlog folder if it donsn't fit well into those templates, with cautions.